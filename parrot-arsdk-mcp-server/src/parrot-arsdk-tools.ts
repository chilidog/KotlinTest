...
import { BluetoothManager, ParrotDevice, PilotingCommand } from './bluetooth-manager.js';
...
export class ParrotARSDKTools {
   ...
   */
  private getListDevicesTool(): Tool {
    return {
      name: 'listDevices',
   ...
   */
  private getDisconnectTool(): Tool {
    return {
      name: 'disconnect',
   ...
   */
  private getSendPilotingCommandTool(): Tool {
    return {
   ...
   */
  private getStartVideoStreamTool(): Tool {
    return {
   ...
   */
  private getStopVideoStreamTool(): Tool {
    return {
  ...
  private async executeListDevices(args: any): Promise<any> {
  ...
  private async executeConnect(args: any): Promise<any> {
  ...
  private async executeDisconnect(args: any): Promise<any> {
  ...
  private async executeGetTelemetry(args: any): Promise<any> {
  ...
  private async executeSendPilotingCommand(args: any): Promise<any> {
    const command: PilotingCommand = args.command;
  ...
  private async executeStartVideoStream(args: any): Promise<any> {
  ...
  private async executeStopVideoStream(args: any): Promise<any> {
